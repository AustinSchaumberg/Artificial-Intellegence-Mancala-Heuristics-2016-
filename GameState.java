 ...
 * current player is always assumed to be on the bottom row. 
 * You are recommended to read and understand this file.
 * -----------------------------------------------------------------------------------------------------------------
 ...
 * 
 * The initial project was developed by Chuck Dyer(dyer@cs.wisc.edu) 
 * and his TAs.
 * 
